...
<html lang="en">
 ...
 <head>
    <title>AdminLTE 4 | Learner Status Report</title>
  </head>
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header py-3">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-sm-6">
                <h4 class="mb-0 fw-semibold text-dark">Learner Status Report</h4>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end mb-0 small">
                  <li class="breadcrumb-item"><a href="#" class="text-decoration-none text-muted">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Learner Status Report</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="app-content">
          <div class="container-fluid">
              ...
              <div class="card-body bg-white p-4">
                <form id="advanced-search-form">
                  <div class="row g-3">
                    ...
                    <!-- Result -->
                    <div class="col-12 col-md-6 col-lg-4">
                      <label class="form-label small fw-semibold text-muted">Result</label>
                      <select class="form-select bg-light border-light-subtle">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                      ...
                      <select class="form-select bg-light border-light-subtle">
                        <option value="NV2600-3" selected>Nv2600 3. Reassembly of Main Parts</option>
                      </select>
                    </div>
            ...
            <!-- Card 2: Learner Status Report -->
            <div class="card shadow-sm border-0 rounded-3 bg-white mb-4">
              <!-- แถบหัวข้อจะแสดงอยู่ตลอดตามภาพ -->
              <div class="card-header bg-white py-3 border-0">
                <h5 class="card-title m-0 fw-semibold fs-6 text-dark d-flex align-items-center gap-2">
                  <i class="bi bi-list-task text-primary"></i> Learner Status Report
                </h5>
              </div>
              ...
              <div id="report-content" class="card-body p-3 pt-0 border-top d-none">
                <!-- ตาราง Tabulator -->
                <div id="learner-status-table"></div>
    ...
    <style>
      ...
      #learner-status-table .tabulator-header {
      ...
      #learner-status-table .tabulator-col {
        background-color: #0091ff !important;
        border-right: 1px solid rgba(255, 255, 255, 0.25) !important;
      }

      #learner-status-table .tabulator-col-title {
        color: #ffffff !important;
      }

      #learner-status-table .tabulator-row {
        border-bottom: 1px solid #edf2f7;
      }

      #learner-status-table .tabulator-row:hover {
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        searchForm.addEventListener('submit', (e) => {
          ...
          if (!table) {
            table = new Tabulator('#learner-status-table', {
        ...
        if (exportBtn) {
          exportBtn.addEventListener('click', () => {
            if (table) {
              table.download('csv', 'Learner_Status_Report.csv');
            }
          });
        }
      });
