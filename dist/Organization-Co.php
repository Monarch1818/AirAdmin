...
<html lang="en">
 ...
 <head>
    <title>AdminLTE 4 | Company</title>
  </head>
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header py-3">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-sm-6">
                <h4 class="mb-0 fw-semibold text-dark">Company</h4>
              </div>
              <div class="col-sm-6">
        ...
        <div class="app-content">
          <div class="container-fluid">
                  ...
                  <form id="company-search-form">
                    <div class="row g-3">
                      <div class="col-12 col-md-6 col-lg-4">
                        <label class="form-label small fw-semibold text-muted">Company Title</label>
                        <input type="text" id="filter-company-title" class="form-control bg-light border-light-subtle">
                      </div>
                    </div>
            ...
            <!-- Card 2: Company Table -->
            <div class="card shadow-sm border-0 rounded-3 bg-white mb-4">
              <div class="card-header bg-white py-3 border-bottom">
                <div class="d-flex align-items-center gap-2 text-dark fw-semibold fs-6">
                  <i class="bi bi-list-task text-primary"></i> Company
                </div>
              </div>
    ...
    <!-- ตกแต่งตาราง Tabulator ให้เป็นหัวสีฟ้าสดใส -->
    <style>
      .form-control:focus,
      .form-select:focus {
      ...
      #company-table .tabulator-header {
      ...
      #company-table .tabulator-col {
        background-color: #0091ff !important;
        border-right: 1px solid rgba(255, 255, 255, 0.25) !important;
      }

      #company-table .tabulator-col-title {
        color: #ffffff !important;
      }

      #company-table .tabulator-header-filter input {
      ...
      #company-table .tabulator-row {
        border-bottom: 1px solid #edf2f7;
      }

      #company-table .tabulator-row:hover {
    ...
    <script>
      document.addEventListener('DOMContentLoaded', () => {
        const data = [
          { id: 1, title: 'Sample Branch 01', organization: 'Brother' },
          { id: 2, title: 'Sample Branch 02', organization: 'Brother' },
          { id: 3, title: 'Sample Branch 03', organization: 'Brother' }
        ];

        const table = new Tabulator('#company-table', {
          data: data,
          layout: 'fitColumns',
          pagination: false,
          columns: [
        ...
        const filterInput = document.getElementById('filter-company-title');
